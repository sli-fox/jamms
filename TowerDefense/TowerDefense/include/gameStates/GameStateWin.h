/** @file GameStateWin.h
 *  @brief File containing the GameStateWin class.
 *
 *  The purpose of this file is to implement a class that
 *  is a concrete game state representing the "game win" state. 
 *
 *  @author Stephanie Li
 */
  ...
  private:
    ...
    */
    ...
    /** @brief Load texture and create StartScreen sprite
      * @return Void.
      */ 
    sf::Sprite getGameWinScreenSprite();
};